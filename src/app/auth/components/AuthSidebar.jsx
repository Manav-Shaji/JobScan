            ...
            <div className="branding-content flex flex-col justify-between h-full">
                ...
                <div>
                    <div className="trust-stats grid grid-cols-3 gap-3.5 my-8">
                        <div className="trust-stat p-4 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] hover:border-[var(--cta)]/30 hover:shadow-[0_8px_20px_rgba(var(--cta-rgb),0.1)] transition duration-300 flex flex-col items-center justify-center text-center group/stat">
