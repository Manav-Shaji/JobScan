...
export function LoginForm({ callbackUrl }) {
    ...
    return (
        <div className="mt-0 outline-none animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            {error && (
                <m.div key="login-error" variants={slideUp} initial="hidden" animate="visible" exit="exit" className="mb-4 flex items-center gap-2.5 text-xs p-3.5 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 font-semibold">
