    ...
    return (
        ...
        >
            ...
            >
                ...
                <motion.div variants={slideUp} className="flex gap-3 justify-center mb-5">
                    ...
                    <motion.a href="#how-it-works" className="btn-premium-secondary flex items-center" {...buttonGestures}>
...
export function AboutSection() {
    return (
        <section id="about" className="py-5 bg-surface-elevated" style={{ borderTop: '1px solid var(--hairline)', borderBottom: '1px solid var(--hairline)' }}>
            <div className="max-w-7xl mx-auto px-4 py-5">
                <motion.div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4">
                ...
                <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-6" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
                    <motion.div variants={slideUp}>
